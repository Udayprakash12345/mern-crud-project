#This is a CRUD Operation project Using MERN stack . working very smoothly and User can store date in database  and user can also list all the data from database on UI part 
